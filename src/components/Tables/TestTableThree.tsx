...
const generateRandomName = (): string => {
  const names = [
    ...
    'Phi', 'Chi', 'Psi', 'Omega', 'Artemis', 'Apollo', 'Athena', 'Hera', 'Hermes', 'Poseidon', 'Zeus',
    'Ares', 'Hephaestus', 'Demeter', 'Hestia', 'Dionysus', 'Hades', 'Persephone', 'Eros', 'Thanatos', 'Helios',
    'Selene', 'Nyx', 'Hypnos', 'Eris', 'Hecate', 'Janus', 'Mars', 'Jupiter', 'Saturn', 'Uranus'
  ];
