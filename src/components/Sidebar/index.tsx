  ...
  return (
    ...
    > 
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 className="text-white font-semibold text-2xl">Admin</h1>
        </NavLink>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <li>
                        <NavLink
                          to="/input-penerima-zakat"
                          className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                            pathname.includes('input-penerima-zakat') &&
                            'bg-graydark dark:bg-meta-4'
                          }`}
                        >
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="data-alternatif"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                pathname.includes('alternatif') &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                            >
                              <MdOutlineDataUsage size={22} />
                              Data Alternatif
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="data-kriteria"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                pathname.includes('data-kriteria') &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                            >
                              <FaListAlt size={22} />
                          ...
                          <li>
                            <NavLink
                              to="bobot-kriteria"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                pathname.includes('bobot-kriteria') &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                            >
                              <GiWeight size={22} />
