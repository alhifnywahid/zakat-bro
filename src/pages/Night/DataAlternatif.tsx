...
import { dataAlternatif } from '../../database/db';
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 mb-6">
        <h1 className="text-2xl font-bold text-[#000000]">Data Alternatif</h1>
      </div>
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              <th className="py-4 px-4 font-medium text-black dark:text-white xl:pl-11 w-[10%]">
                No
              </th>
          ...
          <tbody>
            {dataAlternatif.map((v: any, i) => (
              <tr key={i}>
                ...
                <td className="border-b border-[#eee] py-4 px-4 dark:border-strokedark flex gap-2 items-center justify-center">
